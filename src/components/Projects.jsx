    ...
    return (
        <section className='mt-28'>
           <div className='lg:grid grid-cols-3 justify-center  gap-x-10  px-10'>
                ...
                <Link href='https://rakibsir-client.web.app/' target='_blank' className='singleProject'><Image src={rakib} className='lg:-mt-40 my-5 skeleton'/></Link>
                <Link href='https://nexthunger.vercel.app/' target='_blank' className='singleProject'><Image src={nexthunger} className='lg:-mt-40 my-5 skeleton'/></Link>
           </div>
        </section>
    );
};
